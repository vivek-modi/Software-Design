...
class LLMyFrameALL {
	...
	public static void main(String[] args) {
		MainClass vv = new MainClass("First");
	}

	public static class MainClass extends JFrame implements ActionListener {
		...
		private JButton b8 = new JButton("CountName");
		private JTextField t81 = new JTextField("B", 8);
		JTextField t82 = new JTextField("", 8);
		private JButton b9 = new JButton("AllOlderThan:");
		private JTextField t91 = new JTextField("8", 8);
