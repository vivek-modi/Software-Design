...
public class MyFrame32 {

	public static void main(String[] args) {
		Screenframe mf2 = new Screenframe("First");
	}

	public static class Screenframe extends JFrame implements ActionListener {
