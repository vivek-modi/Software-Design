...
public class MainScreen {
	...
	public static void main(String[] args) {
		implementClass ii = new implementClass("First");
	}

	public static class implementClass extends JFrame implements ActionListener {
		...
		public implementClass(String s) {
			super(s);
